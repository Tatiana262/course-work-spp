...
// BusinessSearch описывает задачу, которая может состоять из нескольких API-запросов
...
// GetBusinessSearches возвращает список задач
...
// GetSearchTasks - возвращает готовый список конкретных задач для адаптера
