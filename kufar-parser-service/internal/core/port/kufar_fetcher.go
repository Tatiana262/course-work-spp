...
// KufarFetcherPort объединяет все операции, которые можно выполнить с источником данных Kufar
type KufarFetcherPort interface {
	...
	FetchAdDetails(ctx context.Context, adId int) (*domain.RealEstateRecord, error)
}