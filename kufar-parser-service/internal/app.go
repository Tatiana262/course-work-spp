...
import (
	...
	"kufar-parser-service/pkg/postgres"
	"kufar-parser-service/pkg/rabbitmq/rabbitmq_common"
	"kufar-parser-service/pkg/rabbitmq/rabbitmq_consumer"
...
type App struct {
	...
	fetchKufarLinksUseCase usecases_port.FetchLinksPort
