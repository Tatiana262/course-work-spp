...
// PostgresLastRunRepository реализует LastRunRepositoryPort
...
// GetLastRunTimestamp извлекает время последнего запуска для указанных параметров
...
// SetLastRunTimestamp устанавливает или обновляет время последнего запуска для указанных параметров
